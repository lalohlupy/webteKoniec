    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="../uvodna_stranka/index.php" class="nav-link" style="color: dodgerblue"
                           onclick="sessionStorage.clear()"><b>Log Out</b></a>
                    </li>
                </ul>
            </div>
        </div>
...
<div id="prehladTestov" class="border border-primary border-2 rounded-3 w-75"
     style="margin-top: 10vh; margin-left: 13%; padding: 30px">
    ...
    <div class="container ">
        <form class="align-items-center" method="post" action="answerUpload.php">
            ...
            <input type="hidden" value="<?= $_SESSION['meno_student'] ?>" name="forename">
            <input type="hidden" value="<?= $_SESSION['priezvisko_student'] ?>" name="surname">
...
<script>
    const onVisibilityChange = () => {
        if (document.hidden) {
            $.post('rest.php', {
                ais_id: <?= $_SESSION['id_student']?>,
                test_key: '<?= $_SESSION['kluc']?>',
                forename: '<?= $_SESSION['meno_student']?>',
                surname: '<?= $_SESSION['priezvisko_student']?>'
            })
